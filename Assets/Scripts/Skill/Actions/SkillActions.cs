...
namespace Game.Skill
{
    ...
    public sealed class DamageAction : ISkillAction
    {
        ...
        public void Execute(SkillActionData actionData, SkillContext context, SkillManager skillManager)
        {
            ...
            for (int i = 0; i < targets.Count; i++)
            {
                ...
                damageInfo.SkillId = context.Config.Id;
    ...
    public sealed class HealAction : ISkillAction
    {
        ...
        public void Execute(SkillActionData actionData, SkillContext context, SkillManager skillManager)
        {
            ...
            if (actionData.TargetType == SkillTargetType.Caster)
            {
                ...
                selfHealInfo.SkillId = context.Config.Id;
            ...
            for (int i = 0; i < targets.Count; i++)
            {
                ...
                healInfo.SkillId = context.Config.Id;
    ...
    public sealed class ApplyModifierAction : ISkillAction
    {
        ...
        public void Execute(SkillActionData actionData, SkillContext context, SkillManager skillManager)
        {
            if (actionData.TargetType == SkillTargetType.Caster)
            {
                skillManager.AddModifier(context.Caster, context.Caster, actionData.ModifierId, actionData.Duration);
                return;
            }
            ...
            for (int i = 0; i < targets.Count; i++)
            {
                ...
                skillManager.AddModifier(context.Caster, target, actionData.ModifierId, actionData.Duration);
            }
        }
    }
