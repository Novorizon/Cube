...
def build_tile():
    ...
    rock = make_rounded_box("Rock", (1.0, 1.0, 0.28), (0, 0, 0.14), mat_rock, bevel=0.035, segments=4)
    soil = make_rounded_box("Soil", (1.0, 1.0, 0.40), (0, 0, 0.48), mat_soil, bevel=0.038, segments=5)
    rock.parent = base
    soil.parent = base

    top_body = make_rounded_box("TopBody", (1.035, 1.035, 0.326), (0, 0, 0.838), mat_grass_top, bevel=0.045, segments=6)
